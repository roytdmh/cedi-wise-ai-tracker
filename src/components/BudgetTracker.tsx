...
import { DollarSign, PiggyBank, AlertTriangle, TrendingUp, Plus, Trash2, History, Calculator } from 'lucide-react';
...
const BudgetTracker = () => {
  ...
  const handleRestoreBudget = (savedBudget: any) => {
    ...
    toast({
      ...
      description: `"${savedBudget.name}" has been loaded into the tracker`
    });
  };
